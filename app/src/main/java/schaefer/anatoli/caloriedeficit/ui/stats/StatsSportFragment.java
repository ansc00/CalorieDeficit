...
public class StatsSportFragment extends Fragment {
    ...
    public StatsSportFragment() {
        // Required empty public constructor
    }


    public static StatsSportFragment newInstance() {
        StatsSportFragment fragment = new StatsSportFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_stats_sport, container, false);

        chart = view.findViewById(R.id.barChartSport);
    ...
    private void setUpChart(final ArrayList<DayEntry> dayEntries) {
        ...
        for(DayEntry de: dayEntries){
            barEntries.add(new BarEntry(count, (float) de.getSumSport()));
            count++;
        }

        BarDataSet dataSet = new BarDataSet(barEntries, getString(R.string.stats_calories_eaten_fragment_burnt_by_sport));

        int color = Color.GREEN;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            color =  Color.argb(1.0f,0.0f,90.0f,0.0f);
        }
        ...
        xAxis.setValueFormatter(new ValueFormatter() {
            ...
            final SimpleDateFormat mFormat = new SimpleDateFormat(pattern, locale);
